...
class Handler(AdminHandler):
    ...
    def change_user_password(self, username, password):
        ...
        if self.get_username() != username and not database.is_sysop(self.get_username()):
    ...
    def admin_post(self):
        ...
        if action == 'create_user':
            ...
            self.create_user(affected_username, password, sysop, can_ban, can_modify_blacklist)
